...
public partial class DbA9acbfDbbibliotecaContext : DbContext
{
    public DbA9acbfDbbibliotecaContext()
    {
    }

    public DbA9acbfDbbibliotecaContext(DbContextOptions<DbA9acbfDbbibliotecaContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("server=SQL8003.site4now.net;database=db_a9acbf_dbbiblioteca;uid=db_a9acbf_dbbiblioteca_admin;pwd=LHurol2022");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Iidnotificacion).HasName("PK__Notifica__7DA9A90A61A270C1");
